---
name: code-review
description: Use when completing tasks, implementing major features, or before merging — covers both requesting reviews and receiving/acting on feedback
---

# Code Review

Two-part skill: requesting code reviews (dispatching reviewer) and receiving feedback (evaluating and implementing).
...
- Implement feedback without understanding it
- Batch fixes without testing each one
