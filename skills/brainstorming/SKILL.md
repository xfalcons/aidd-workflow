...
6. **Write design doc** — save to `aidd-docs/inception/specs/{NNN}-YYYY-MM-DD-<topic>-design.md` (read **Next Doc ID** from `aidd-state.md` under `## Document Counter`, increment after saving) and commit
...
- Write the validated design (spec) to `aidd-docs/inception/specs/{NNN}-YYYY-MM-DD-<topic>-design.md` (serial-number prefixed)
